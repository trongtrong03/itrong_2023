...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、Transform 的基本語法</h2>
    ...
    <div class="text-block">
        <h2 id="act4">四、如何改變元素變形的中心點起始位置？</h2>
    ...
    <div class="text-block">
        <h2 id="act5">五、3D 變形效果的透視概念（perspective）</h2>
...
.child {
    ...
    <div class="text-block">
        <h2 id="act7">七、進階：Transform 的 Matrix（矩陣）</h2>
