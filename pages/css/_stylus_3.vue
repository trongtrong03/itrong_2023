...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、Alpha 透明度（alpha）</h2>
...
// 輸出結果為 0.4</code></pre>
    ...
    <div class="text-block">
        <h2 id="act3">三、加深（darken）/減輕（lighten）</h2>
    ...
    <div class="text-block">
        <h2 id="act7">七、取得影像尺寸（image-size）</h2>
