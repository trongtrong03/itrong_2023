...
.new {
    ...
    <div class="text-block">
        <h2 id="act4">四、如何正確書寫選擇器 Coding Style？</h2>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="text-block">
        <h2 id="act5">五、進階：CSS3 新增的選擇器一覽</h2>
