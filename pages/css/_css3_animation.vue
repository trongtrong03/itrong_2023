...
@keyframes fadeIn {
    ...
    <div class="text-block">
        <h2 id="act2">二、要如何製作動畫影格並讓指定元素取得它？</h2>
...
@keyframes fadeIn {
    ...
    <div class="text-block">
        <h2 id="act5">五、動畫首尾呼應需要設定相同的關鍵影格嗎？</h2>
    ...
    <div class="text-block">
        <h2 id="act7">七、如何讓元素在動畫執行完後保持最後結束的狀態？</h2>
