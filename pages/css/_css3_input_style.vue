...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、客製化 checkbox / radio</h2>
...
input[type="checkbox"]:checked + label::before {
    ...
    <div class="text-block">
        <h2 id="act3">三、阻止使用者隨意拖曳 textarea 大小</h2>
    ...
    <div class="text-block">
        <h2 id="act4">四、改變 input 的 placeholder 樣式</h2>
...
input:-moz-placeholder {
  ...
  color: red;
    ...
    <div class="text-block">
        <h2 id="act5">五、input 的 autofill</h2>
