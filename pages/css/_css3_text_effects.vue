...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act0">序、前言</h2>
        <p>過去 CSS 針對文字的操作大多集中於大小、字距或換行方面的格式調整，較少就文字本身效果方面做變化，而 CSS3 則大幅度補足了這方面的缺憾，不僅可以利用相關屬性給予文字特殊的效果變化，也可以結合其他像是變形（Transform）或濾鏡（Filter）這類型的特效屬型，讓文字有更多元、豐富的變化。本篇文章內容主要介紹些 CSS3 新增的文字特效屬性，以及分享一些網路各路高手利用純 CSS 語法編寫的特效文字創作。</p>
    </div>
    <div class="text-block">
        <h2 id="act1">一、文字陰影</h2>
