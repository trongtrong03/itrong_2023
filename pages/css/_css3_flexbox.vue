...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、什麼是 Flexible Box？</h2>
...
.child {
    ...
    <div class="text-block">
        <h2 id="act5">五、子元件之間的對齊方式能不一樣嗎？</h2>
...
@media only screen and (max-width: 768px) {
    ...
    <div class="text-block">
        <h2 id="ac8">八、父容器 flex 與 inline-flex 的差異？</h2>
