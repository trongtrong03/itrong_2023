<template>
    <NuxtLayout name="article">
        <TempArticle :propValue="12" fileType="learnJs" />
<!-- start -->
<div class="text-content">
    ...
    <div class="text-block" id="act0">
        <h2>序、前言</h2>
        <p>以前學 JavaScript 的第一堂課，一定會學到變數是由關鍵字 <em>var</em> 來作宣告，然後再將變數運用到之後的函式之中。但自 ES2015 版本（也可以泛稱 <b>ES6</b>）問世開始，變數宣告方式除了原本的 <em>var</em>，還新增了 <em>const</em> 與 <em>let</em> 這兩種方式，當然，JavaScript 不可能平白無故白白增加兩個性質功能一樣的東西把工程師搞矇，本篇主要來談談為什麼 <b>ES6</b> 要特地新增兩個變數宣告方式，它們與 <em>var</em> 有什麼差異。</p>
    </div>
...
console.log(x);    // 4</code></pre>
        ...
        <p><em>for</em> 迴圈中的變數 <em>x</em> 跑完之後的新值，取代掉原本全域變數 <em>x</em> 的值（<em>100</em>）。</p>
        <p>再看一例：</p>
        <div class="text-code" v-pre>
...
console.log(x);    // "pen"</code></pre>
        ...
        <p>由於條件式中 <em>y > 3</em> 條件成立（<em>true</em>），因此 <em>x</em> 將重新賦值為 <em>pen</em>。</p>
...
console.log(obj);    // {"name": "John", "years": 33}</code></pre>
    ...
    <div class="text-block" id="act4">
        ...
        <p><br></p>
        <h3>宣告不給值：</h3>
        <p>當我們只先單純宣告一個變數 <em>x</em>，卻不給它值然後讓程式去調用，編譯將會發生什麼結果。</p>
        <div class="text-flex">
            <div class="f-width">
                <div class="f-head">
                    <div class="f-f0">關鍵字</div>
