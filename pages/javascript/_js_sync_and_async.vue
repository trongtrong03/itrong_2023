...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、Synchronous（同步）</h2>
...
"執行D任務"</code></pre>
    ...
    <div class="text-block">
        <h2 id="act2">二、Asynchronous（非同步）</h2>
...
"執行B3任務"</code></pre>
    ...
    <div class="text-block">
        <h2 id="act4">四、JavaScript 的非同步處裡</h2>
...
var timeoutID = window.setInterval(( () => console.log("Hello!") ), 3000);</code></pre>
        ...
        <p><em>setTimeout</em> 和 <em>setInterval</em> 差別在於前者只會在計時到點時執行一次，而後者則是會在設定的計時時間不斷循環去做，例如我們設定參數為 <em>3000</em>（三秒），則每三秒就會執行一次 <em>setInterval</em> 裡面的函式。</p>
        <p><br></p>
