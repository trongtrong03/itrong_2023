...
<div class="text-content">
    ...
    <div class="text-block">
        <h2 id="act1">一、認識 HTTP Live Streaming</h2>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-1.jpg">
        </figure>
    ...
    <div class="text-block">
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-2.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-3.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-4.jpg">
        </figure>
        <p><br></p>
        <h6>2. 輸入網址</h6>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-5.jpg">
        </figure>
        <p>將要觀看的 HLS 串流 URL 複製貼到「請輸入網址」的輸入框裡，最後按下「播放」便能觀看影音內容了。</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-6.jpg">
        </figure>
    </div>
    <div class="text-block">
        <h2 id="act3">三、如何下載與轉換</h2>
        <p>除了支援播放串流影音之外，VLC media player 也可以把裡面影音內容下載下來（或稱轉換）。步驟如下：</p>
        <h6>1. 在輸入串流網址的下方「播放」旁箭頭->「轉換」</h6>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-7.jpg">
        </figure>
        <p>首先在輸入串流網址的下方「播放」按鈕旁邊有一顆小的三角形按鈕，點擊後會出現清單，選擇「轉換」：</p>
        <p><br></p>
        <h6>2. 選擇要轉換的格式</h6>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-8.jpg">
        </figure>
        <p>接著會跳出彈窗，在設定檔的下拉清單中選擇想要轉換的格式，例如 720P 畫質的 .mp4 格式，選擇好後按下目的檔案儲存位置的「瀏覽」按鈕：</p>
        <p><br></p>
        <h6>3. 更改檔案名稱</h6>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-9.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-10.jpg">
        </figure>
        <p>前往儲存檔案的資料夾位置可以查看完成轉換的輸出檔案：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-11.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-12.jpg">
        </figure>
        <p>讓它偵測監聽一會兒，底下會慢慢列出該網頁使用到的各項資源文件。我們可以在「篩選」輸入框輸入「m3u8」，來過濾出我們要找的 HLS 串流檔案：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-13.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-14.jpg">
        </figure>
        <p>至於底下那兩個檔案就是播放清單的檔案：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-15.jpg">
        </figure>
        <p>確認後便可以切換回「標頭」（Headers）的頁籤：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-16.jpg">
        </figure>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-17.jpg">
        </figure>
    ...
    <div class="text-block">
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-29.jpg">
        </figure>
        <p>儘管版本號未必會相同，但如果有回饋以下這些資訊就代表環境設置的操作是有成功的：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-30.jpg">
        </figure>
        <p><br></p>
        <h3>MAC 安裝流程：</h3>
        <h6>1. 安裝 Homebrew</h6>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-31.jpg">
        </figure>
        <p>點擊下載第一個壓縮檔連結：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-32.jpg">
        </figure>
        <p>下載好後解壓縮，你會得到一個名稱「ffmepg」的 Unix 執行檔：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-33.jpg">
        </figure>
...
$ ./ffmpeg [option]</code></pre>
        ...
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-34.jpg">
        </figure>
        <div class="text-code" v-pre>
        ...
        <p>結果：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-35.jpg">
        </figure>
        <p><br></p>
        <h3>合併檔案：</h3>
        ...
        <p>結果：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-36.jpg">
        </figure>
        <p><br></p>
        <h3>製作 M3U8 播放清單：</h3>
        ...
        <p>結果：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-37.jpg">
        </figure>
        ...
        <p>然後得到：</p>
        <figure>
            <img src="/images/knowledge/m3u8/m3u8-38.jpg">
        </figure>
